...
const RPC_URL =
  (ENV && ENV.VITE_RPC_URL) ||
  (ENV && ENV.VITE_ALCHEMY_API_KEY && ('https://eth-sepolia.g.alchemy.com/v2/' + ENV.VITE_ALCHEMY_API_KEY)) ||
  (ENV && ENV.VITE_INFURA_API_KEY && ('https://sepolia.infura.io/v3/' + ENV.VITE_INFURA_API_KEY)) ||
